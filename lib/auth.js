...
// wait 5 seconds to let db connect before updating rolemap initially
setTimeout(updateRoleMap, 1 * 5000)
...
function keyGuard (app, key) {
  return async function (ctx, next) {
    const isAuthorized = ctx.query['api_key'] === key
...
module.exports = { adminGuard, keyGuard }
